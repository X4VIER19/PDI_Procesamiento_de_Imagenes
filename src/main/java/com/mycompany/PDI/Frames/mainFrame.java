...
import com.mycompany.PDI.HistogramaRenderer;
import com.mycompany.PDI.Waifu2XProcessor;
...
public class mainFrame extends javax.swing.JFrame {
    ...
    private void buttonUpScaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpScaleActionPerformed
        ...
        if (!Waifu2XProcessor.isWaifu2XAvailable()) {
            // Si es Linux y en caso de que el archivo existe pero no tiene permisos
            // Preguntamos al usuario si quiere darselos
